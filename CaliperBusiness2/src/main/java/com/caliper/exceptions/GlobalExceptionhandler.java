...
public class GlobalExceptionhandler {
	...
	public ResponseEntity<MyErrorDetails> handleResourceNotFound(CustomerNotFound exception, WebRequest request) {

		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), exception.getMessage(),
	...
	// api exception
	public ResponseEntity<MyErrorDetails> apiNotFoundHandler(ApiException ex, WebRequest re) {

		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), ex.getMessage(), re.getDescription(false));
